<script lang="ts">
	...
	import { BOT_MODEL, botDelay, selectBotMove, shapedBotMove, shapedLabelFor, shapedSearchDepth } from '$brain/bot';
	import { personaById, personaInternalElo, type BotPersona } from '$brain/bots';
	import { estimatePlayerElo } from '$brain/playerElo';
	...
	import { CLASS } from '$brain/classifications';
	...
	import { getFenAfter, getPgn, getSan, getState, isPromotionMove, loadFen, makeMove, reset, undo } from '$brain/engine/chess';
	import {
		deleteGame,
		gameAccuracy,
		labelCounts,
		...
		type StoredGame,
		type StoredMove
	} from '$brain/gameStore';
	import { explainGoodMove, explainMove, motifTags, type Explanation } from '$brain/engine/explain';
	import {
		backfillGrade,
		gradeMove,
		whitePovWinChance,
	...
	import { botSpec, botEloMax, botEloMin } from '$brain/engine/botRecipe';
