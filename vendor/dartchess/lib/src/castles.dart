...
abstract class Castles {
  ...
  static const standard = Castles(
    ...
    whitePathQueenSide: SquareSet.fromHiLo(0x00000000, 0x0000000e),
    whitePathKingSide: SquareSet.fromHiLo(0x00000000, 0x00000060),
    blackPathQueenSide: SquareSet.fromHiLo(0x0e000000, 0x00000000),
    blackPathKingSide: SquareSet.fromHiLo(0x60000000, 0x00000000),
  );
  ...
  static const horde = Castles(
    castlingRights: SquareSet.fromHiLo(0x81000000, 0x00000000),
    blackRookKingSide: Square.h8,
    blackRookQueenSide: Square.a8,
    whitePathKingSide: SquareSet.empty,
    whitePathQueenSide: SquareSet.empty,
