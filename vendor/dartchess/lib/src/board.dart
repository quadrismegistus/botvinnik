...
class Board {
  ...
  static const standard = Board(
    occupied: SquareSet.fromHiLo(0xffff0000, 0x0000ffff),
    promoted: SquareSet.empty,
    white: SquareSet(0xffff),
    black: SquareSet.fromHiLo(0xffff0000, 0x00000000),
    pawns: SquareSet.fromHiLo(0x00ff0000, 0x0000ff00),
    knights: SquareSet.fromHiLo(0x42000000, 0x00000042),
    bishops: SquareSet.fromHiLo(0x24000000, 0x00000024),
    rooks: SquareSet.corners,
    queens: SquareSet.fromHiLo(0x08000000, 0x00000008),
    kings: SquareSet.fromHiLo(0x10000000, 0x00000010),
  );
  ...
  static const horde = Board(
    occupied: SquareSet.fromHiLo(0xffff0066, 0xffffffff),
    promoted: SquareSet.empty,
    white: SquareSet.fromHiLo(0x00000066, 0xffffffff),
    black: SquareSet.fromHiLo(0xffff0000, 0x00000000),
    pawns: SquareSet.fromHiLo(0x00ff0066, 0xffffffff),
    knights: SquareSet.fromHiLo(0x42000000, 0x00000000),
    bishops: SquareSet.fromHiLo(0x24000000, 0x00000000),
    rooks: SquareSet.fromHiLo(0x81000000, 0x00000000),
    queens: SquareSet.fromHiLo(0x08000000, 0x00000000),
    kings: SquareSet.fromHiLo(0x10000000, 0x00000000),
  );
