...
extension type const SquareSet(int value) {
  ...
  ///
  /// The web implementation cannot hold 64 bits in one int, so every literal
  /// wider than 32 bits in this library is written through this constructor
  /// and both implementations accept it.
  const SquareSet.fromHiLo(int hi, int lo) : value = (hi << 32) | lo;
