...
void main() {
  group('SquareSet', () {
    test('toHexString', () {
      ...
      expect(const SquareSet.fromHiLo(0x00000000, 0x00000001).toHexString(),
          '0x0000000000000001');
    ...
    test('shr', () {
      const r = SquareSet.fromHiLo(0x0e0a1222, 0x1e222212);
      expect(r.shr(0), r);
      expect(r.shr(1), const SquareSet.fromHiLo(0x07050911, 0x0f111109));
      expect(r.shr(3), const SquareSet.fromHiLo(0x01c14244, 0x43c44442));
    ...
    test('shl', () {
      const r = SquareSet.fromHiLo(0x0e0a1222, 0x1e222212);
      expect(r.shl(0), r);
      expect(r.shl(1), const SquareSet.fromHiLo(0x1c142444, 0x3c444424));
      expect(r.shl(3), const SquareSet.fromHiLo(0x70509110, 0xf1111090));
      expect(r.shl(10), const SquareSet.fromHiLo(0x28488878, 0x88884800));
      expect(r.shl(32), const SquareSet.fromHiLo(0x1e222212, 0x00000000));
      expect(r.shl(48), const SquareSet.fromHiLo(0x22120000, 0x00000000));
      expect(r.shl(62), const SquareSet.fromHiLo(0x80000000, 0x00000000));
    ...
    test('from file', () {
      expect(const SquareSet.fromFile(File(0)),
          const SquareSet.fromHiLo(0x01010101, 0x01010101));
      expect(const SquareSet.fromFile(File(7)),
          const SquareSet.fromHiLo(0x80808080, 0x80808080));
    });

    test('from rank', () {
      expect(const SquareSet.fromRank(Rank(0)),
          const SquareSet.fromHiLo(0x00000000, 0x000000ff));
      expect(const SquareSet.fromRank(Rank(7)),
          const SquareSet.fromHiLo(0xff000000, 0x00000000));
    });
...
'''));
      ...
      expect(const SquareSet.fromSquare(Square.h8),
          const SquareSet.fromHiLo(0x80000000, 0x00000000));
    });
