...
// footnote: bundling js-chess-engine for the Horizon personas put BigInt
// literals in brain.js (`0n`), and QuickJS gates BigInt behind CONFIG_BIGNUM.
// A build without it fails to PARSE the bundle, so JsBridge.load() would throw
// and the whole app would fail to boot — not merely lose one bot family.
// Check this before adding an Android target.
